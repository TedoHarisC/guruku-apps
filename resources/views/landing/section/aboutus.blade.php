<section id="about">
      <div class="container">
        ...
        <header class="section-header">
          <h3>Aplikasi Pencarian Guru Les Privat Untuk SD , SMP , dan SMA</h3>
          <p>GuruKu merupakan sebuah aplikasi yang menyediakan layanan pencarian Guru Les Privat dari kalangan pengajar maupun mahasiswa yang Cepat , Terpercaya , dan Harga Terjangkau</p>
        </header>
        ...
        <div class="row about-container">
          ...
          <div class="col-lg-6 content order-lg-1 order-2">
            <p>
              Apa saja sih keunggulan dari menggunakan GuruKU ? 
            </p>

            <div class="icon-box wow fadeInUp">
              <div class="icon"><i class="fa fa-shopping-bag"></i></div>
              <h4 class="title"><a href="">Memesan Guru Privat Cepat , Mudah , dan Terpercaya</a></h4>
              <p class="description">Et harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.2s">
              <div class="icon"><i class="fa fa-photo"></i></div>
              <h4 class="title"><a href="">Memberikan Rekomendasi Guru Privat yang terdekat dengan Lokasi Anda</a></h4>
              <p class="description">Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum</p>
            </div>

            <div class="icon-box wow fadeInUp" data-wow-delay="0.4s">
              <div class="icon"><i class="fa fa-bar-chart"></i></div>
              <h4 class="title"><a href="">Harga Terjangkau Namun Mendapat Kualitas Pengajar yang Unggul</a></h4>
          ...
          <div class="col-lg-6 background order-lg-2 order-1 wow fadeInUp">
            <img src="{{ asset('landing') }}/img/about-img.svg" class="img-fluid" alt="">
          </div>
        </div>
        ...
        <div class="row about-extra">
          <div class="col-lg-6 wow fadeInUp order-1 order-lg-2">
            <img src="{{ asset('landing') }}/img/about-extra-2.svg" class="img-fluid" alt="">
          </div>
